...
public class FeatureUtils {
  public static double Score(String feature1, String feature2) {
    ...
    float[] feat1Floats = ConvUtils.bytes2floatArray(feat1Decode, 0, feat1Decode.length);
    float[] feat2Floats = ConvUtils.bytes2floatArray(feat2Decode, 0, feat1Decode.length);
    double dis = 0;
